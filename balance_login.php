...
<html>
	...
	<h1>Welcome <?php echo $_SESSION['SESS_FIRST_NAME'];?></h1>
		...
		<form method="post" align="center" action="balance_passwordcheck.php">
			<table width="400" border="0" align="center" cellpadding="2" cellspacing="0">
				...
				<tr>
					<td width="200"><input name="history_submit" type="submit" class="textfield" id="history_submit" required /></td>
				</tr>
			</table>
		</form>
	</body>
